...
public class FullyQualifiedJavaType implements Comparable<FullyQualifiedJavaType> {
   ...
   * element. Therefore, it does not support fully qualified inner classes. Not totally fool proof, but correct in most
   * instances.
   *
  ...
  /**
   * Returns a list of Strings that are the fully qualified names of this type, and any generic type argument associated
   * with this type.
   *
