 ...
 *
 * @author orange1438 2016/10/11 23:10
 */
public class MybatisServicePlugin extends PluginAdapter {
  ...
  public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
    ...
    interfaceType = new FullyQualifiedJavaType(servicePack + "." + Constant.INTERFACE_PREFIX + tableName + "Service");
  ...
  protected Method selectByExample(IntrospectedTable introspectedTable, String tableName) {
    Method method = new Method();
    String name = "selectByExample";
    if (introspectedTable.hasBLOBColumns()) {
      name = "selectByExampleWithoutBLOBs";
      tableName = tableName + "WithBLOBs";
    }
    method.setName(name);
